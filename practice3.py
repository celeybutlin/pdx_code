import random # random is a module built into python
...
print(random.choice(grades)) #print random grade (from above)
print(random.randint(0,10)) #print random integer 0-10
